Module Module1
    ...
    Sub Main()
        ...
        Dim pathUsuarios As String = "C:\Users\ESTUDIANTE\Desktop\sustentacion\ProyectoFacturación\usuarios.xml"
        ...
        Dim menu As MenuPrincipal = New MenuPrincipal(arregloUsers, path, pathCategorias, pathProductos, pathUsuarios)
        menu.Iniciar()
