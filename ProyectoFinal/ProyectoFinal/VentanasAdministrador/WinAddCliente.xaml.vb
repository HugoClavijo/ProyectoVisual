...
Public Class WinAddCliente
    Private dbPath As String = "..\..\sample.mdb"
    Public strConexion As String = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & dbPath
    Dim dsCliente As DataSet
    Dim dsProvincia As DataSet

    Private Sub AddUsuarios_Loaded(sender As Object, e As RoutedEventArgs) Handles AddClientes.Loaded
    ...
    Private Sub DataWindow_Closing(sender As Object, e As ComponentModel.CancelEventArgs)
        Dim clientes As WinAdminClientes
        clientes = Me.Owner
        clientes.Show()
        'Me.Hide()
    End Sub
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As RoutedEventArgs) Handles btnGuardar.Click
        ...
        Dim listClients As WinAdminClientes = Me.Owner
    ...
    Private Sub BtnBorrar_Click(sender As Object, e As RoutedEventArgs) Handles btnBorrar.Click
        ...
        Using conexion As New OleDbConnection(listClients.strConexion)
            ...
            Dim consulta As String = "Delete * FROM cliente WHERE nombre ='" & txtNombre.Text & "';"
            ...
            'adapter.Update(dsCliente.Tables("cliente"))
            If found Then
                MessageBox.Show("No se borró el cliente")
            End If
            'Catch es As Exception
            '    MessageBox.Show("Error al actualizar")
            'End Try
